...
function LoginPage() {
  return (
    <div className="row">
      <div className="col-6" id="lestSection">
        <div className="w-25" id="fbLogo">
          <svg
      ...
      <div className="col-6" id="rightSection">
        <form className="form-signin m-auto bg-light ">
        ...
        <p className="pt-4" id="lastPara"><span>Create a Page </span>for a celebrity, brand or business.</p>
      </div>
    </div>
